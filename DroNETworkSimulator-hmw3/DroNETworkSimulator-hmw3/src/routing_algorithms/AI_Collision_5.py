...
class AI_Collision_1811110_5(BASE_routing):
...
##############################################################
    ...
    def relay_selection(self, opt_neighbors, pkd):
        ...
        if self.last_choice_index != 1 and self.last_choice_index != 2 and self.drone.buffer_length() >= 5 or self.last_choice_index == 0:

...
CODE_TO_RUN = "python -m src.experiments.experiment_ndrones -nd {} -i_s {} -e_s {} -alg {}"
PLOT_CODE = "python -m src.experiments.json_and_plot -i_s {} -e_s {} "
NUM_CORE = 8
...
if __name__ == "__main__":
    # execution
    ALGO_TO_RUN = ["AI", "MGEO", "GEO", "RND"] # run algorithms
    #ALGO_TO_RUN = ["AI_5", "AI_8", "AI_10"] # run algorithms
    NDRONES = [2, 5, 10, 15, 20] # 15, 20, 30, 40
    NSEEDS = 10  # 30
